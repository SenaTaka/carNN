...
![Track Editor Screenshot](https://github.com/user-attachments/assets/9a4ab819-3861-48ba-8ec1-7a70902356b5)

## 主な機能

✨ **直感的な操作**: クリック＆ドラッグでウェイポイントを配置
🎨 **リアルタイムプレビュー**: 編集中にトラックがリアルタイムで表示
📐 **精密な調整**: コース幅やスケールを細かく設定可能
💾 **柔軟なエクスポート**: JSONファイルまたはPythonコードで出力
📂 **簡単インポート**: 既存のトラックを読み込んで編集可能
